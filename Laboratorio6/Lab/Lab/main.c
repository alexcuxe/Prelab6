 ...
 * Lab.c
 *
 * Created: 23/04/2024 08:20:57 a. m.
...
int main(void)
{
	//DDRD = 0xFC;		//PD2 - PD7 as output  1100 0000
	//DDRB = 0x03;		//PB0 y PB1 as output ff
	...
	*/
	...
	writeText("Opciones\n");
	writeText("- Leer potenciómetro");
	writeText("- Enviar Ascii");
	*/
    while (1) 
    {
